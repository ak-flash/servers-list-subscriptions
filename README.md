...
Сервис для управления VPN подписками с админ-панелью. Позволяет создавать пользователей и добавлять работающие серверы (VLESS, VMess, Trojan, Shadowsocks), генерировать ссылки подписок для клиентских приложений.

![Скриншот админ-панели](img/screenshot.jpg)
...
| `SESSION_SECRET` | Секрет для сессий | `vpn-subscription-secret-key-2026` |
